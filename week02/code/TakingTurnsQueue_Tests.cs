...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: PersonQueue inserted new people at the front, making the queue LIFO instead of FIFO.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: People with zero or negative turns were not added back to the queue.
    ...
    // Defect(s) Found: No defect found; the empty queue exception matched the requirement.
